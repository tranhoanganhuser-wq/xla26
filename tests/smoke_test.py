...
sys.path.insert(0, str(ROOT / "project1_mini_photoshop"))
sys.path.insert(0, str(ROOT / "project2_document_digitization"))

from processing import adjust_brightness, adjust_contrast, apply_blur, compute_histogram
from document_processing import process_document
from pdf_export import export_images_to_pdf
...
def main():
    ...
    pdf_path = ROOT / "tests" / "_smoke_output.pdf"
